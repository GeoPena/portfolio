        ...
        <aside className="md:col-span-1 space-y-6">
          ...
          <div className="p-4 border rounded-md">
            <div className="flex items-center space-x-2">
              <Mail width={24} height={24} className="text-gray-600" />
              <h3 className="font-semibold">Stay up to date</h3>
            </div>
            <p className="text-sm text-gray-600 mt-1">Get notified when I publish something new.</p>
          ...
          <div className="p-4 border rounded-md">
            {/* Title with Icon */}
            <div className="flex items-center space-x-2">
              <BriefcaseBusiness width={24} height={24} className="text-gray-600" />
            ...
            <ul className="mt-2 text-sm space-y-3">
              {[
                ...
                { company: "Microsoft", logo: "/MicrosoftLogo.png", role: "SOFTWARE ENGINEER", date: "2010 - 2011" },
              ].map((job, index) => (
                <li key={index} className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">{job.role}</p>
                    </div>
                  </div>
          ...
          <div className="p-4 border rounded-md">
            {/* Title with Icon */}
            <div className="flex items-center space-x-2">
              <Zap width={24} height={24} className="text-gray-600" />
